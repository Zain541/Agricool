...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="{{ asset('admin_panel/images/favicon.ico') }}" type="image/x-icon">
    <!-- Plugins Core Css -->
    <link href="{{ asset('admin_panel/css/app.min.css') }}" rel="stylesheet">
    <!-- Custom Css -->
    <link href="{{ asset('admin_panel/css/style.css') }}" rel="stylesheet" />
    <!-- Theme style. You can choose a theme from css/themes instead of get all themes -->
    <link href="{{ asset('admin_panel/css/all-themes.css') }}" rel="stylesheet" />
</head>
...
<body class="light">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30">
                <img class="loading-img-spin" src="{{ asset('admin_panel/images/loading.png') }}" alt="admin">
            </div>
            <p>Please wait...</p>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="{{ asset('admin_panel/images/logo.png') }}" alt="" />
                ...
                <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="body">
                                <ul class="menu">
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{ asset('admin_panel/images/user/user1.jpg') }}" alt="">
                                            </span>
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{ asset('admin_panel/images/user/user2.jpg') }}" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{ asset('admin_panel/images/user/user3.jpg') }}" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{ asset('admin_panel/images/user/user4.jpg') }}" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{ asset('admin_panel/images/user/user5.jpg') }}" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{ asset('admin_panel/images/user/user6.jpg') }}" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{ asset('admin_panel/images/user/user7.jpg') }}" alt="">
                                            </span>
                                            <span class="menu-info">
                                                <span class="menu-title">John Doe</span>
                                                <span class="menu-desc">
                    ...
                    <li class="dropdown user_profile">
                        <div class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ asset('admin_panel/images/user.jpg') }}" alt="user">
                        </div>
                        <ul class="dropdown-menu pullDown">
                            <li class="body">
                ...
                <ul class="list">
                    <li>
                        <div class="sidebar-profile clearfix">
                            <div class="profile-img">
                                <img src="{{ asset('admin_panel/images/usrbig.jpg') }}" alt="profile">
                            </div>
                    ...
                    <li class="active">
                        <a href="{{route('admin.home')}}">
                         <i class="menu-icon ti-home"></i><span>Home </span></a>
                    ...
                    <li class="">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="{{ route('project.index') }}">View</a>
                            </li>
                            <li>
    ...
    <script src="{{ asset('admin_panel/js/bundles/amcharts4/core.js') }}"></script>
    <script src="{{ asset('admin_panel/js/bundles/amcharts4/charts.js') }}"></script>
    <script src="{{ asset('admin_panel/js/bundles/amcharts4/animated.js') }}"></script>
